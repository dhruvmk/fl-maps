...
import i18n from '/imports/both/i18n/en/emergency'

let categoryTree = i18n.EmergencyCategories
let labels = i18n.EmergencyNewEventModal
...
const Events = new Mongo.Collection('emergency-events')
